...
description: Web-based chat UI for wallet interaction.
---

The Chat Interface is a **web-based chat UI** built with TanStack Start that allows users to interact with their Solana wallet through a conversational interface.
